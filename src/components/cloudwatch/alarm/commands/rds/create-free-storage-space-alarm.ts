...
export class CreateFreeStorageSpaceAlarmCommand extends CreateAlarmCommand {
    constructor(
    ...
    execute(parent?: AlarmStore) {
        ...
        const logicalName = `${this.name}-free-storage-space`;
        ...
        const metricName = 'FreeStorageSpace';
        const stat = 'Average';
